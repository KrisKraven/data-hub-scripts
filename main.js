...
<div id="first-time-prompt" style="background:#e3f2fd;padding:25px;border-radius:16px;margin:20px 0;text-align:center;display:none;">
  ...
  <input type="email" id="email" placeholder="Email (optional)" style="width:100%;padding:14px;margin:10px 0;border-radius:8px;border:1px solid #ccc;">
      ...
      function sendBeacon(page) {
        fetch('https://hook.us2.make.com/7ozrdbk7h2q1topau4u71v6y2b6u9bpm', {
          ...
          body: JSON.stringify({
            ...
            phone_verified: localStorage.getItem('user_phone_verified') || 'none',
            email:     localStorage.getItem('user_email') || 'none',
            t:         easternTime,
            p:         page,
